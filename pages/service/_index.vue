        ...
        <div class="service-container">
          <div class="service-title">
            <div class="d-flex flex-column">
              <h1 v-if="serviceInfo.title">{{ serviceInfo.title }}</h1>
              <h1 v-else>Delivery Trucks</h1>
              <p v-if="serviceInfo.sub_title">{{ serviceInfo.sub_title }}</p>
              <p v-else>
          ...
          <div class="service-banner">
            <img v-if="serviceInfo.image" :src="serviceInfo.image" alt="" />
            <img v-else src="../../assets/images/Rectangle 23908.png" alt="" />
          </div>
          <div
            class="service-desc"
            v-if="serviceInfo.deckription"
            v-html="serviceInfo.deckription"
          ></div>
          <div class="service-desc" v-else>
            <p>
              Sasco Global provides professional and comprehensive Air Freight
          ...
          <div class="service-btn-group">
            <nuxt-link to="/">Use service</nuxt-link>
            <nuxt-link to="/">Use service</nuxt-link>
          </div>
        </div>
...
export default {
  ...
  async asyncData({ params, store, i18n }) {
    const serviceInfo = await store.dispatch("fetchServices/getServicesInner", {
